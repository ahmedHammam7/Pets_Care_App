...
class FinishAppoinmentBody extends StatefulWidget {
  const FinishAppoinmentBody(
      {super.key, required this.pet, required this.clinic});
  final PetResponse pet;
  final ClinicResponseData clinic;
  @override
  State<FinishAppoinmentBody> createState() => _FinishAppoinmentBodyState();
}

DateTime selectedDate = DateTime.now();
TimeOfDay selectedTime = TimeOfDay.now();

class _FinishAppoinmentBodyState extends State<FinishAppoinmentBody> {
  @override
                      ...
                      PrimaryButton(
                        ...
                        onTap: () async {
                          FormData body = FormData.fromMap({
                            ...
                            "clinic_id": widget.clinic.id.toString(),
                            "day":
                                "${selectedDate.day}/${selectedDate.month}/${selectedDate.year}",
