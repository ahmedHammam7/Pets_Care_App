...
//signup
  ...
  //store store
  getIt.registerLazySingleton<StoreStoreRepos>(
      () => StoreStoreRepos(getIt(), dio));
  ...
  // client clinics
  getIt.registerLazySingleton<OwnerClincsRepo>(() => OwnerClincsRepo(getIt()));
  getIt.registerFactory<OwnerClinicsCubit>(() => OwnerClinicsCubit(getIt()));
  //cart
